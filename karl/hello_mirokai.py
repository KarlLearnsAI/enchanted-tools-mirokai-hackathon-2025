...
async def main():  
    async with connect(api_key, robot_ip) as robot:
        ...
        walk = robot.go_to_relative(Coordinates(x=1.0, y=1.0, theta=0.0))
        ...
        walk2 = robot.go_to_relative(Coordinates(x=0.0, y=1.0, theta=0.0))
        ...
        walk3 = robot.go_to_relative(Coordinates(x=1.0, y=1.0, theta=0.0))
        ...
        # walk4 = robot.go_to_relative(Coordinates(x=2.0, y=1.0, theta=0.0))
        ...
        walk5 = robot.go_to_relative(Coordinates(x=-2.0, y=-3.0, theta=0.0)) # -4, -4
